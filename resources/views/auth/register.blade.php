            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row mb-3">
                            <label for="lahir" class="col-md-4 col-form-label text-md-end">{{ __('Usia') }}</label>

                            <div class="col-md-6">
                                <input id="lahir" type="number" class="form-control @error('Usia') is-invalid @enderror" name="lahir" value="{{ old('lahir') }}" required autocomplete="lahir">
