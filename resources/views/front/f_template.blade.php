					   ...
					   <ul class="nav">
						  <li class="dropdown1"><a >Kualitas</a>
							  <ul class="dropdown2">
									...
									<li><a href="/indexP?kategori=Premium">Premium</a></li>
									<li><a href="/indexH?kategori=High Class">High Class</a></li>												
							  </ul>
						  </li>          
						 ...
						 <li>
							<a href="#" data-toggle="modal" data-target="#l3" class="button2" onclick="showCart()"><img src="{{ asset('template\front') }}/images/cart.png" alt=""/>
							</a>
							<div class="modal fade" id="l3" tabindex="-1" role="dialog">
		 ...
		 <div class="slider">
					   <div class="callbacks_container">
						   <ul class="rslides" id="slider">
							    <li><h1>SAMPOERNA</h1></li>
								<li><h1>DJARUM SUPER</h1></li>	
								<li><h1>DUNHILL</h1></li>	
								<li><h1>LA BOLD</h1></li>
								<li><h1>DJI SAM SOE</h1></li>
						  </ul>
						  <p>Tembakau <span>rasa</span> kualitas <span>super</span> seperti <span>cinta kita</span></p>
						  <a class="morebtn" href="/">TEMBAKAU SUPER</a>
					  </div>
				  </div>
	 </div>
	 <div class="dwn">
		<a class="scroll" href="#cate"><img src="{{ asset('template\front') }}/images/scroll.png" alt=""/></a>
	 </div>				 
</div>
<!--/banner-->
@yield('content')
