...
<!-- Custom Theme files -->
<link href="{{ asset('template\front') }}/css/form.css" rel="stylesheet" type="text/css" media="all" />
           ...
           <div class="header">
                ...
                <div class="top-nav">										 
                      ...
                      <ul class="nav" style="background-color: rgb(226, 129, 17) ">
                       ...
                       <li>
                        <a href="#" data-toggle="modal" data-target="#myModal3" class="button2" onclick="showCart()"><img src="{{ asset('template\front') }}/images/cart.png" alt=""/>
                        </a>
